...
public class HomePageScooter {
    ...
    private final By placeOrderHeaderButton = By.xpath(".//button[@class='Button_Button__ra12g']");
    //Кнопка Заказать в конце второй секции основной страницы
    private final By placeOrderMainButton = By.className("Button_Middle__1CSJM");
