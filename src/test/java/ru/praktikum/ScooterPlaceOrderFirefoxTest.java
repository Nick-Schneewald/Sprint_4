...
public class ScooterPlaceOrderFirefoxTest {
    ...
    public ScooterPlaceOrderFirefoxTest(String name, String surname, String address, String phoneNumber, String metroStation, String date, By duration, By colour, String comment,  boolean result){
