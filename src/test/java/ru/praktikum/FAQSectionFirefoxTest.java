...
public class FAQSectionFirefoxTest {
    ...
    public FAQSectionFirefoxTest(String question, String answer, boolean result) {
    ...
    @Parameterized.Parameters(name = "{index}. Тест на соответствие вопроса {0} ответу {1}, ожидается ответ {2}  ")
