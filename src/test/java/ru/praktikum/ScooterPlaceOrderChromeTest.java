...
public class ScooterPlaceOrderChromeTest {
    ...
    public ScooterPlaceOrderChromeTest(String name, String surname, String address, String phoneNumber, String metroStation, String date, String duration, String colour, String comment, boolean result) {
